...
def pushToLambda():
    ...
    p = subprocess.Popen("aws lambda update-function-code --function-name ComputerCommands --zip-file fileb://" +
                         "D:/Programming/1.GitHub_Repos/AlexaComp/Lambda/Main_Lambda/package.zip",
